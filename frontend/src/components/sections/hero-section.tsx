        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="max-w-xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 leading-tight">
              Build smarter forms with AI, <span className="text-purple-600">faster than ever.</span>
            </h1>
            <p className="mt-6 text-lg text-gray-600">
              Create beautiful, intelligent forms in seconds with our AI-powered platform. Just describe what you need,
              and we'll build it for you. No coding required.
            </p>
